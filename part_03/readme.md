...
The actual deliverable for this section is fairly small. Submit a progress report detailing where you are with your Capstone in Google Classroom. The format and content is up to you but, at a minimum, we expect the following:
...
- Your progress report (touching on the points above) submitted no later than (see course info) on the Google Form your instructors will provide.
